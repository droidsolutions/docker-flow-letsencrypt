...
#common arguments
args=("--no-self-upgrade" "--register-unsafely-without-email" "--update-registration" "--no-bootstrap" "--standalone" "--non-interactive" "--expand" "--keep-until-expiring" "--agree-tos" "--preferred-challenges" "http-01" "--rsa-key-size" "4096" "--redirect" "--hsts" "--staple-ocsp")
